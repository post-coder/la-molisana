<script>
import AppPasta from './AppPasta.vue';
...
<template>
  <div id="main">
    ...
    <div id="pasta-container">
      ...
      <!-- per passare la prop ci serve indicarla con i due punti : iniziali -->
      <AppPasta v-for="product in products" :img="product.src" :title="product.titolo"></AppPasta>
